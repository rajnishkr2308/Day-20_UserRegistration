...
public class UserTest {
    ...
    public void firstNameHappyTest() {
        boolean firstName = user.checkFirstName("Rajnish");
    ...
    public void checkLastNameHappyTest() {
        boolean lastName = user.checkLastName("Kumar");
        Assert.assertTrue(lastName);
    }

    @Test
    public void checkLastNameSadTest() {
        boolean lastName = user.checkLastName("raj");
        Assert.assertFalse(lastName);
    }

    @Test
    public void phoneNumberHappyTest() {
        boolean phoneNumber = user.checkMobileNumber("917541061533");
        Assert.assertTrue(phoneNumber);
    }

    @Test
    public void phoneNumberBadTest() {
        boolean phoneNumber = user.checkMobileNumber("12221 7541061533");
        Assert.assertFalse(phoneNumber);
    }

    @Test
    public void passwordHappyTest() {
        boolean password = user.checkPassword("Rajnish123@");
    ...
    public void emailHappyTest() {
        boolean email = user.checkEmail("rajneeshsingh9905@gmai.com");
        Assert.assertTrue(email);
    }

    @Test
    public void emailSadTest() {
        boolean email = user.checkEmail("rajneesh.@gmai.com");
